  ...
  return (
    <div className="mb-12 relative group px-0 md:px-0">
      <div className="relative">
        ...
        {needsScrolling && (
          <div
            className={`flex md:hidden absolute left-0 top-0 bottom-0 w-12 z-40 bg-gradient-to-r from-[#1a1d29] to-transparent items-center justify-center transition-opacity duration-300 ${
        ...
        <div
          ...
          className={`flex overflow-x-auto px-4 md:px-12 py-8 gap-4 no-scrollbar scroll-smooth items-center ${
            !needsScrolling ? "justify-center" : ""
          }`}
        >
          {categories.map((category) => (
            <Link
              ...
              className="flex-none w-[60vw] sm:w-[40vw] md:w-[20vw] lg:w-[16vw] transition-all duration-300"
            >
              <div className="aspect-[16/9] rounded-lg overflow-hidden bg-gray-800 shadow-lg hover:shadow-[0_40px_58px_-16px_rgba(0,0,0,0.8)] border-[3px] border-[rgba(249,249,249,0.1)] md:group-hover:border-[#00b4d8]/40 hover:!border-[#00b4d8] transition-all duration-300 hover:scale-105 relative">
                {category.bannerImage ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-700 to-gray-900 p-2">
                    <span className="text-lg sm:text-xl md:text-2xl font-bold text-white drop-shadow-lg text-center leading-tight tracking-wide">
                      {category.title}
                    </span>
                  </div>
                )}
        ...
        {needsScrolling && (
          <div
            className={`flex md:hidden absolute right-0 top-0 bottom-0 w-12 z-40 bg-gradient-to-l from-[#1a1d29] to-transparent items-center justify-center transition-opacity duration-300 ${
